...
write.csv(fifty_states,file="C:/Users/sri21arun/Desktop/UTD/Statistical Methods for Data Science/Mini Project/Mini_Project2/fifty_states.csv")

# Get a shape file of states in the US
# Get the data to be plotted
usa.df <- read.table("C:/Users/sri21arun/Desktop/UTD/Statistical Methods for Data Science/Mini Project/Mini_Project2/fifty_states.csv", header = T, sep = ",")
usa.dat <- read.table("C:/Users/sri21arun/Desktop/UTD/Statistical Methods for Data Science/Mini Project/Mini_Project2/us_2016_election_data.csv", header = T, sep = ",")
...
ggsave(p(usa.df, brks.to.use, figure.title), height = 4, width = 4*1.9,
       file = "C:/Users/sri21arun/Desktop/UTD/Statistical Methods for Data Science/Mini Project/Mini_Project2/usa_voters.jpg")
